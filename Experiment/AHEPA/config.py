...
def config():
    return {
    # Paths
    'dataset_path': "/teamspace/studios/this_studio/phdResearch/data1/",
    
    'models_path': "/teamspace/studios/this_studio/Phd/Models",
    'output_dir': "/teamspace/studios/this_studio/Phd/experiment/AHEPA/results",
    #Cross Dataset if on
    'CrossDataset': "off", 
    'traindataset': "",
    'testdataset': "",
    ...
    'k_folds': 5,
    'random_state': 42,
    'fold_strategy': 'manual65', #'manual65', #'stratified'
    ...
    # Experiment tracking
    'experiment_name': "Ahepagithub", #None
    'save_config': True,
    'evaluate': False
}
