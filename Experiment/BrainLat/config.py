...
def config():
    return {
    # Paths
    'dataset_path': "/teamspace/studios/this_studio/phdResearch/data2/",
    
    'models_path': "/teamspace/studios/this_studio/phdResearch/Models",
    'output_dir': "/teamspace/studios/this_studio/Phd/experiment/BrainLat/results",
    #Cross Dataset if on
    'CrossDataset': "off", 
    'traindataset': "",
    'testdataset': "",
    ...
    'k_folds': 5,
    'random_state': 42,
    'fold_strategy': 'manual67', #'stratified'
    ...
    # Experiment tracking
    'experiment_name': "brainlatgithub", #None
    'save_config': True
}
